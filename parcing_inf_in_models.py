...
та requests для виконання HTTP-запитів. Дані отримуються з веб-сторінки IMDb, зберігаються у HTML файл 
і потім аналізуються для отримання деталей про фільми та зберігається в базі даних
"""
